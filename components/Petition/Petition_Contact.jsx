        ...
        <form action="">
          ...
          <div>
                                    <label className="block text-gray-500" for="remember">
                                        <input className="mr-6 leading-tight w-5 h-5 rounded-xl" type="checkbox" id="remember" name="remember" />
                                        <span className="text-[18px]">
                                            Display my name and comment on this petition
                                        </span>
                                    </label>
                                </div>
        <button className="cursor-pointer py-2 px-4 block mt-6 bg-red text-white font-bold w-full text-center rounded">Sign this petition</button>
      </form>
    );
};
